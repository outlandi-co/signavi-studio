...
const accountBtn = { marginLeft: "auto", padding: "8px 16px", background: "#22c55e", color: "black", borderRadius: 6 }
...
const drawerBtn = { padding: 12, background: "#0f172a", color: "white", borderRadius: 6 }
const logoutBtn = { marginTop: 20, background: "#ef4444", padding: 12, borderRadius: 6 }