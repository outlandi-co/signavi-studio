...
export default function CustomQuote() {
  ...
  const quantityServices = ["apparel", "vinyl", "laser"]
  const usesQuantity = quantityServices.includes(form.printType)
  ...
  const handleServiceSelect = (key) => {
    setForm((prev) => ({
      ...prev,
      printType: key,
      quantity: quantityServices.includes(key)
        ? prev.quantity || 1
        : 1
    }))
  }
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_.9fr]">
          ...
          <aside className="h-fit rounded-3xl border border-slate-800 bg-slate-950/80 p-6 shadow-xl shadow-black/20 backdrop-blur md:p-8">
            ...
            <div className="mb-6 rounded-3xl border border-cyan-400/30 bg-cyan-400/10 p-6">
              ...
              {usesQuantity && perItemEstimate !== null ? (
            ...
            <p className="mt-6 text-sm leading-relaxed text-slate-500">
              ...
              project scope, turnaround time, product availability, setup,
              shipping, session length, editing, and production requirements.
            </p>
