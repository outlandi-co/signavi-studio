...
export default function CustomQuote() {
  ...
  /*
   * Quantity pricing only applies to Custom Apparel.
   * All other services are treated as project-based estimates.
   */
  const usesQuantity = form.printType === "apparel"
  ...
  /*
   * Bulk discounts only apply to apparel.
   */
  let discount = 1
  let discountMsg = ""
  ...
  /*
   * Apparel:
   * base × quantity × discount
   *
   * Other services:
   * base starting estimate
   */
  const rawEstimate = usesQuantity
  ...
  const perItemEstimate = usesQuantity
    ? estimate / qty
    : null
  ...
  const handleServiceSelect = (key) => {
    setForm((prev) => ({
      ...prev,
      printType: key,
      quantity: key === "apparel" ? prev.quantity || 1 : 1
    }))
  }
      ...
      <section className="mx-auto max-w-7xl">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-3xl text-lg leading-relaxed text-slate-400">
            ...
            This estimate gives a starting point,
            and your final quote will be reviewed
            before approval.
          </p>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_.9fr]">
            ...
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <label className="flex flex-col gap-2 md:col-span-2">
                ...
                <span className="text-xs text-slate-500">
                  Final scheduling is confirmed by
                  SignaVi Studio after review.
                </span>
              ...
              <label className="flex flex-col gap-2 md:col-span-2">
                ...
                <textarea
                  ...
                  value={form.notes}
                  onChange={handleChange}
                  placeholder="Describe your project, sizes, colors, material, logo placement, session details, event length, or any important information..."
                  rows="6"
                  className="rounded-xl border border-slate-700 bg-[#020617] px-4 py-3 text-white outline-none transition focus:border-cyan-400"
                />
          ...
          <aside className="h-fit rounded-3xl border border-slate-800 bg-slate-950/80 p-6 shadow-xl shadow-black/20 backdrop-blur md:p-8">
            ...
            <div className="mb-6 rounded-3xl border border-cyan-400/30 bg-cyan-400/10 p-6">
              ...
              {usesQuantity &&
                perItemEstimate !== null && (
                  <p className="mt-2 text-sm text-slate-400">
                    About $
                    {perItemEstimate.toFixed(2)}{" "}
                    per item
                  </p>
                )}
            ...
            <p className="mt-6 text-sm leading-relaxed text-slate-500">
              Final pricing may change based on
              material, artwork complexity,
              project scope, turnaround time,
              product availability, setup,
              shipping, session length, editing,
